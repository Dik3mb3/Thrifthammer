"""
One-time command to write the 50 verified Amazon prices into the database.

All price/URL data was extracted from the Octoparse Amazon spreadsheet and
manually verified by cross-referencing product names, gw_search_name values,
and Amazon ASINs.
...
AMAZON_PRICES = {
    ...
    # --- Newly identified matches (manual cross-reference of spreadsheet vs DB) ---
    "40-03":  ("96.82",  "https://www.amazon.com/Warhammer-40-000-Starter-Set/dp/B0CBKLS5XD/"),
    "46-25":  ("138.00", "https://www.amazon.com/2025-ver-Combat-Patrol-Aeldari/dp/B0DYFB9D4G/"),
    "48-06":  ("58.65",  "https://www.amazon.com/Games-Workshop-Warhammer-Terminator-playstation-5/dp/B0CJS2HQ3B/"),
    "48-23":  ("68.00",  "https://www.amazon.com/Games-Workshop-Predator-SW/dp/B08LR2G2DN/"),
    "48-32":  ("39.95",  "https://www.amazon.com/Games-Workshop-Warhammer-Chaplain-Terminator/dp/B0CJRZJPM9/"),
    "48-34":  ("39.95",  "https://www.amazon.com/Games-Workshop-Warhammer-Marines-Terminator/dp/B0G315GMCV/"),
    "48-92":  ("51.00",  "https://www.amazon.com/Games-Workshop-99120101184-Primaris-Aggressors/dp/B0746GR78Q/"),
    "56-15":  ("75.65",  "https://www.amazon.com/Games-Workshop-Empire-Crisis-Battlesuit/dp/B09SZPLZ7X/"),
    "56-16":  ("100.00", "https://www.amazon.com/Empire-XV104-Riptide-Battlesuit-Warhammer/dp/B00KUU7C6U/"),
    "56-19":  ("40.80",  "https://www.amazon.com/Warhammer-Tau-Empire-Pathfinder-Team/dp/B016S4S9OK/"),
    "71-20":  ("138.45", "https://www.amazon.com/Warhammer-40-000-Combat-Patrol/dp/B0CNTW5X5S/"),
}


class Command(BaseCommand):
    """Apply 50 verified Amazon prices to the database (no xlsx needed)."""

    help = (
        "Write the 50 manually verified Amazon prices into CurrentPrice. "
