...
CROSS_FACTION_UNITS = {
    ...
    # ── Imperial Fists ────────────────────────────────────────────────────────
    # IF-exclusive units (Darnath Lysander 60-01, Tor Garadon 60-02) are tagged
    # faction=imperial-fists in the DB — populate_units handles them.
    # The two Blood Angels-parented units (Chaplain with Jump Pack 41-27,
    # Librarian in Terminator Armour 41-28) are skipped until BA UnitType names
    # are confirmed (same skip as Dark Angels).
    "Imperial Fists": {
        "parent_faction": "Space Marines",
        "units": [
            ...
            {"parent": "Space Marine Apothecary",
             "name":   "Apothecary"},
            # IF army list has both Apothecary and Apothecary Biologis — same kit:
            {"parent": "Space Marine Apothecary",
    ...
    # ── Iron Hands ────────────────────────────────────────────────────────────
    # IH-exclusive units (Caanok Var 61-01, Iron Father Feirros 61-02) are
    # tagged faction=iron-hands — populate_units handles them.
    ...
    # ── Raven Guard ───────────────────────────────────────────────────────────
    # RG-exclusive units (Aethon Shaan 62-01, Kayvaan Shrike 62-02) are
    # tagged faction=raven-guard — populate_units handles them.
    # Two units use Blood Angels kits (41-xx); skip until BA UnitType names
    # are confirmed (Chaplain with Jump Pack, Librarian in Terminator Armour).
    "Raven Guard": {
        "parent_faction": "Space Marines",
    ...
    # ── Salamanders ───────────────────────────────────────────────────────────
    # Salamanders-exclusive units (Adrax Agatone 63-01, Vulkan He'stan 63-02)
    # are tagged faction=salamanders — populate_units handles them.
    # Two units use Blood Angels kits (41-xx); skip until BA UnitType names
    # are confirmed (Chaplain with Jump Pack, Librarian in Terminator Armour).
    "Salamanders": {
        "parent_faction": "Space Marines",
